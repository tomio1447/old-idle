...
function applyOnlineAuthorityState(descriptor,terminalReason,version){
  ...
  // Megalomania: morreu e ainda há luta — sai do lobby e volta ao templo.
  if(typeof megaLobbyEjectDeadToTemple==="function"&&previous&&!terminalReason)
    megaLobbyEjectDeadToTemple(previous);
  if(terminalReason){
