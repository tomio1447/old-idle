...
try{
  ...
  // Falcon Bastion: hunt 250+ (Falcon Knight/Paladin + mini bosses).
...
const HUNTS=Object.assign(read("hunts.json"),{
  ...
  "falcon-bastion":{monsters:["falcon-knight","falcon-paladin"],cat:"hard",pack:7,packMin:6,packMax:8,
    ...
    spawnWeights:{"falcon-knight":30,"falcon-paladin":30,
      "grand-commander-soeren":10,"preceptor-lazare":10,"grand-chaplain-gaunder":10,"grand-canon-dominus":10}},
