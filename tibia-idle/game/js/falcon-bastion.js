...
const FALCON_BASTION_ITEMS = {
  ...
  "falcon-circlet":           { n: "falcon circlet", s: "helmet", t: "helmet", cid: 28714, w: 1.30, sell: 0, npcSell: 0, arm: 8, mag: 2, res: { fire: 9 }, lvl: 300, vocs: ["sorcerer", "master sorcerer", "druid", "elder druid"], imbSlots: 2 },
  ...
  "falcon-sai":               { n: "falcon sai", s: "weapon", t: "fist", cid: 50161, w: 8.20, sell: 0, npcSell: 0, atk: 45, def: 20, lifeLeech: 14.0, lvl: 300, vocs: ["monk"], th: true, imbSlots: 2 },
...
(function registerFalconBastion() {
  ...
  GAMEDATA.hunts["falcon-bastion"] = {
    ...
    spawnWeights: {
      "falcon-knight": 30,
      "falcon-paladin": 30,
      "grand-commander-soeren": 10,
      "preceptor-lazare": 10,
      "grand-chaplain-gaunder": 10,
      "grand-canon-dominus": 10,
    },
    color: "#6a6a7a",
    scene: "cave",
