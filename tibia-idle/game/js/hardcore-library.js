...
(function addHardcoreLibrary() {
  ...
  ], withLoot([{ chance: 18, max: 2, item: "flask-of-demonic-blood" }]), { fire: 100, ice: -10, earth: 20 });
  ...
  ], withLoot([{ chance: 24, max: 3, item: "ultimate-health-potion" }]), { fire: 100, ice: -5, earth: 20 });
  ...
  ], withLoot([{ chance: 9, max: 1, item: "energy-ball" }]), { energy: 100, earth: -10, death: 15 });
  ...
  ], withLoot([{ chance: 22, max: 5, item: "small-sapphire" }, { chance: 5, max: 1, item: "frosty-heart" }, { chance: 2, max: 1, item: "leviathan-s-amulet" }]), { ice: 100, fire: -10, energy: 15 });
  ...
  ], withLoot([{ chance: 18, max: 3, item: "small-emerald" }, { chance: 6, max: 1, item: "ruby-necklace" }]), { earth: 100, fire: -10, ice: 15 });
  ...
  ], withLoot([{ chance: 34, max: 5, item: "meat" }, { chance: 10, max: 1, item: "big-bone" }, { chance: 7, max: 1, item: "ruby-necklace" }]), { fire: 10, energy: 10, earth: 10 });
  ...
  ], withLoot([{ chance: 26, max: 5, item: "small-sapphire" }, { chance: 8, max: 1, item: "glacier-mask" }]), { ice: 100, fire: -10, energy: 10 });
  ...
  Object.assign(GAMEDATA.hunts, {
    "library-fire": hunt("Secret Library — Fire Section", 400, ["burning-book", "rage-squid", "biting-book"], "#b64425", 15167, 12567, 783, 75, 95),
