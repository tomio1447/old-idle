...
window.WIKI_CONDITION_ICONS = {
  ...
  "cond-goshnar-taint-1": { nome: "Goshnar's Taint I", tipo: "negative", desc: "10% de chance de criaturas teleportarem até o personagem em áreas Soul War." },
  "cond-goshnar-taint-2": { nome: "Goshnar's Taint II", tipo: "negative", desc: "Também adiciona 0,5% de chance de surgir outra criatura ao atacar." },
  "cond-goshnar-taint-3": { nome: "Goshnar's Taint III", tipo: "negative", desc: "Também aumenta todo dano recebido em 15%." },
  "cond-goshnar-taint-4": { nome: "Goshnar's Taint IV", tipo: "negative", desc: "Também dá 10% de chance de uma criatura recuperar toda a vida ao morrer." },
  "cond-goshnar-taint-5": { nome: "Goshnar's Taint V", tipo: "negative", desc: "Também remove 10% da vida e mana atuais a cada 10 segundos." },
