...
window.WIKI_CONDITIONS = {
  ...
  rooted: {
    ...
    desc: "Impede de se mover por 3 segundos (Rooted). Magias e itens continuam liberados.",
  },
  feared: {
    icon: "cond-feared", nome: "Feared", tipo: "negative",
    desc: "O personagem foge da criatura que aplicou o efeito e não pode usar magias nem itens.",
  },
  slowed: {
...
window.WIKI_CONDITION_ICONS = {
  ...
  "cond-goshnar-taint-1": { nome: "Goshnar's Taint I", tipo: "negative", desc: "10% de chance de uma criatura teleportar perto de você." },
  "cond-goshnar-taint-2": { nome: "Goshnar's Taint II", tipo: "negative", desc: "0,5% de chance de uma nova criatura surgir perto de você se você atingir outra criatura." },
  "cond-goshnar-taint-3": { nome: "Goshnar's Taint III", tipo: "negative", desc: "Dano recebido aumentado em 15%." },
  "cond-goshnar-taint-4": { nome: "Goshnar's Taint IV", tipo: "negative", desc: "10% de chance de uma criatura se curar completamente em vez de morrer." },
  "cond-goshnar-taint-5": { nome: "Goshnar's Taint V", tipo: "negative", desc: "Perda de 10% dos seus pontos de vida e da sua mana a cada 10 segundos." },
  ...
  "cond-rooted": { nome: "Rooted", tipo: "negative", desc: "Impede de se mover por 3 segundos. Magias e itens continuam liberados." },
