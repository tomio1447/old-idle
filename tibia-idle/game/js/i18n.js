...
const I18N = {
  pt: {
    ...
    "config.fullhd.hint": "Sobe a resolução do canvas, encaixa os tiles em pixels inteiros e suaviza o downscale. Remove borrão, embaçamento e o aspecto quadriculado do pixel art esticado.",
    "config.close": "Fechar",
  ...
  en: {
    ...
    "config.fullhd": "FULLHD",
    "config.fullhd.hint": "Raises canvas resolution, snaps tiles to whole pixels and smooths the downscale. Removes blur, smear and the checkered look of stretched pixel art.",
    "config.close": "Close",
    "server.status": "SERVER STATUS:",
    "server.online": "ONLINE",
    "server.offline": "OFFLINE",
