...
(function aplicarSupplyStashData() {
  ...
  /* Soft boots (Canary 3549): 4h equipadas; ao acabar viram worn soft boots.
   * Não entram na Supply Stash (só rings/amulets). */
  if (IT["pair-of-soft-boots"]) {
    Object.assign(IT["pair-of-soft-boots"], {
      chargeMode: "time",
      durationSec: 14400,
      charges: durCharges(14400),
      decayToSlug: "worn-soft-boots",
      hpreg: IT["pair-of-soft-boots"].hpreg || 3,
      mpreg: IT["pair-of-soft-boots"].mpreg || 12,
    });
  }
