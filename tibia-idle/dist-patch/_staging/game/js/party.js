...
async function partyOnlineInvite(name) {
  ...
  if (z.zone !== "city" && z.zone !== "training") {
    return { ok: false, msg: "O líder só pode convidar estando na Cidade (safe zone) ou Área de Treino" };
  }
  // Sincroniza leader_zone antes do invite — UI local pode estar no templo
