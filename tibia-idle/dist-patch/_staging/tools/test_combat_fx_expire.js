...
must(indexSrc.includes("render.js?v=phys-hit-combo-v1") || indexSrc.includes("render.js?v="),
  "cache-bust render.js");
must(indexSrc.includes("game.js?v=phys-hit-combo-v1") || indexSrc.includes("game.js?v="),
  "cache-bust game.js");
must(indexSrc.includes("combat.js?v="),
