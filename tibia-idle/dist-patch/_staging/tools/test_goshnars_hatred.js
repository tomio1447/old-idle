...
must(html.includes("js/soulwar.js?v=yasir-loot-meta-v1")&&
  html.includes("js/yasir-prices.js?v=goshnar-yasir-v1"),
  "index sem cache-bust soulwar/yasir Goshnar prices");
