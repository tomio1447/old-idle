...
ANI = {
    ...
    "WHIRLWINDCLUB": "whirlwind-club", "ETHEREALSPEAR": "ethereal-spear",
    "HUNTINGSPEAR": "hunting-spear", "ENCHANTEDSPEAR": "enchanted-spear",
    "ROYALSPEAR": "royal-spear", "SNIPERARROW": "sniper-arrow", "ONYXARROW": "onyx-arrow",
    "PIERCINGBOLT": "piercing-bolt", "INFERNALBOLT": "infernal-bolt",
