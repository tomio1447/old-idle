...
-- Convites (inbox assíncrono): o convidado pode trocar para o personagem,
-- abrir a interface de Party e aceitar de lá. Um personagem só pode ter
-- 1 convite PENDENTE por vez (UNIQUE parcial via pending_invitee_id).
-- Histórico accepted/declined/expired/cancelled pode acumular sem conflito.
