...
if (!/c\.deadAt = Date\.now\(\)/.test(combat)) throw Error('Início do contador de morte ausente');
console.log('OK: corpse oficial Canary 4240/4247 e contador vermelho ascendente validados.');
