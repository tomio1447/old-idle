...
(async()=>{
  ...
  must(html.includes("js/account-client.js?v=party-runtime-v3")&&html.includes("js/party.js?v=party-runtime-v3")&&
    html.includes("js/party-ui.js?v=party-runtime-v3")&&html.includes("js/game.js?v=party-runtime-v3"),
