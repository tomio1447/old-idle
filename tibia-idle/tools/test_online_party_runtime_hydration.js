...
(async()=>{
  ...
  must(html.includes("js/account-client.js?v=missions-v1")&&html.includes("js/party.js?v=party-xp-v1")&&
    html.includes("js/party-ui.js?v=party-runtime-v7")&&html.includes("js/game.js?v=online-fix-v9"),
