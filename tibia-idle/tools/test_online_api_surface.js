...
const required=[
  ...
  "/api/instance","/api/instance/tick","/api/instance/ammo","/api/instance/pouch-clear","/api/instance/pouch-sell","/api/instance/stash-move","/api/stash/move","/api/instance/end","/api/characters",
...
must(db.includes("JsonStore.prototype.instancePatchState")&&db.includes("async instancePatchState")&&
  ...
  "storage/API não persistem a troca de munição/limpeza/venda de pouch na autoridade");
