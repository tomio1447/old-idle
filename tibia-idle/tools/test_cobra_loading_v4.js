...
function verifyIndexOrder() {
  ...
  const cobra = html.indexOf('src="js/cobra-bastion-map.js?v=cobra-loading-v14"');
  const otbm = html.indexOf('src="js/otbm.js?v=cobra-loading-v14"');
  const otbmhunt = html.indexOf('src="js/otbmhunt.js?v=cobra-loading-v14"');
  ...
  for (const file of ["otbm", "otbmhunt", "hard-hunts", "tileanimdata",
    ...
    must(html.includes(`src="js/${file}.js?v=cobra-loading-v14"`),
