...
vm.runInContext(`
  ...
  // 3. Posição do ED/MS permanece numa reta a 3 SQMs do knight.
  ...
  // Um objeto vazio reproduz snapshots antigos, nos quais Map era perdido pelo JSON.
  const c2 = { players: [], mobs: [], _formationReservations: {} };
