...
must(html.includes('id="btn-auto-walk"')&&html.includes('id="sqm-walk-hud"')&&
  ...
  html.includes("js/gridai.js?v=sqm-hud-v1")&&html.includes("js/game.js?v=knight-fx-combo-v2")&&
  html.includes("js/party-ui.js?v=sqm-hud-v1")&&html.includes("js/player.js?v=knight-fx-combo-v1")&&
  html.includes("css/layout.css?v=knight-fx-combo-v1"),
